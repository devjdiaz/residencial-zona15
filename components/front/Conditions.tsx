        ...
        <div className="cond-grid reveal d1">
          <div className="cond">
            ...
            <div>
              ...
              <p>Contratos pensados para estancias estables, con opción a renovar.</p>
            </div>
          </div>
          ...
          <div className="cond">
            ...
            <div>
              ...
              <p>Espacios para una persona por habitación. Ambiente tranquilo y respetuoso.</p>
            </div>
          </div>
          ...
          <div className="cond">
            ...
            <div>
              <h4>Depósito de Q1,000</h4>
              <p>Reembolsable al finalizar, sujeto al estado de la habitación.</p>
            </div>
          </div>
          ...
          <div className="cond">
            ...
            <div>
              ...
              <p>La renta se cubre al inicio de cada mes. Servicios ya incluidos.</p>
            </div>
          </div>
        </div>
